...
import { MobileIcon, EnvelopeIcon, MapPinIcon } from "./Icons";
      ...
      <div className="container">
        <div className="row g-4 mb-4">
          <div className="col-lg-4">
            ...
            <div className="d-flex gap-2 mt-3">
              <a href="https://instagram.com/tourged.id" target="_blank" rel="noopener noreferrer" className="social-link text-decoration-none" aria-label="Instagram">
              ...
              <a href="https://youtube.com/@tourgedid" target="_blank" rel="noopener noreferrer" className="social-link text-decoration-none" aria-label="YouTube">
              ...
              <a href="https://wa.me/6281280904772" target="_blank" rel="noopener noreferrer" className="social-link text-decoration-none" aria-label="WhatsApp">
          ...
          <div className="col-lg-4">
            ...
            <ul className="list-unstyled small">
              <li className="mb-2 d-flex align-items-center gap-2"><MobileIcon size={14} /> +62 812-8090-4772</li>
              <li className="mb-2 d-flex align-items-center gap-2"><EnvelopeIcon size={14} /> tourgedid@gmail.com</li>
              <li className="mb-2 d-flex align-items-center gap-2"><MapPinIcon size={14} /> Jakarta, Indonesia</li>
            </ul>
            <a
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-center small">
          ...
          <div className="d-flex gap-3 mt-2 mt-md-0">
            <a href="https://wa.me/6281280904772" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,0.5)" }} className="text-decoration-none">Contact Us</a>
          </div>
        </div>
      </div>
    </footer>
